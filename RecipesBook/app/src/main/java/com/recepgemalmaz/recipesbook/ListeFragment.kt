...
class ListeFragment : Fragment() {
    ...
    private lateinit var listeRcyclerAdapter: ListeRcyclerAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listeRcyclerAdapter = ListeRcyclerAdapter(yemekIsmiListesi,yemekIdListesi)
        val recyclerView = view.findViewById<androidx.recyclerview.widget.RecyclerView>(R.id.recyclerView)
        recyclerView.layoutManager = LinearLayoutManager(context)
        recyclerView.adapter = listeRcyclerAdapter
    ...
    fun SqlVeriAlma(){
        try {
            ...
            activity?.let {
                ...
                listeRcyclerAdapter.notifyDataSetChanged()
                cursor.close()
